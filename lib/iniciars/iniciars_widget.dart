...
import '../cuentades/cuentades_widget.dart';
...
class IniciarsWidget extends StatefulWidget {
  const IniciarsWidget({Key key}) : super(key: key);

  @override
  _IniciarsWidgetState createState() => _IniciarsWidgetState();
}

class _IniciarsWidgetState extends State<IniciarsWidget> {
