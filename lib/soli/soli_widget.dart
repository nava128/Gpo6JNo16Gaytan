...
class SoliWidget extends StatefulWidget {
  const SoliWidget({Key key}) : super(key: key);

  @override
  _SoliWidgetState createState() => _SoliWidgetState();
}

class _SoliWidgetState extends State<SoliWidget> {
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Ej. GAHL040820MCHYRSA9',
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyText1.override(
                                fontFamily: 'Lexend Deca',
                                color: Color(0xFF57636C),
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Domino\'s'),
                                content: Text(
                                    'Tu solicitud de empleo ha sido enviada'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
