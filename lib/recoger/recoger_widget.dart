...
class RecogerWidget extends StatefulWidget {
  const RecogerWidget({Key key}) : super(key: key);

  @override
  _RecogerWidgetState createState() => _RecogerWidgetState();
}

class _RecogerWidgetState extends State<RecogerWidget> {
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'Ingrese la sucursal',
                    hintText: 'Ej. Sucursal #10 ',
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                        color: Color(0xFFAFAFAF),
                        width: 1,
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'Gracias por su preferencia, en 30 minutos podra recoger su Domino\'s'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
